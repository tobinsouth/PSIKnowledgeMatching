...
with open("datasets/subquora/qrels_full.json", "w") as f:
    json.dump(qrels, f)
...
with open("datasets/subquora/corpus_embeddings_full.pkl", "wb") as f:
    pickle.dump(corpus_embeddings_dict, f)
with open("datasets/subquora/query_embeddings_full.pkl", "wb") as f:
