...
with open(f"datasets/{DATASET}/qrels_full2.json", "w") as f:
    json.dump(qrels, f)
...
csv_file_path = f'results/{DATASET}/eval_metrics_DRES_{DATASET}2.csv'
...
with open(f"datasets/{DATASET}/corpus_embeddings_full2.pkl", "wb") as f:
    pickle.dump(corpus_embeddings_dict, f)
with open(f"datasets/{DATASET}/query_embeddings_full2.pkl", "wb") as f:
